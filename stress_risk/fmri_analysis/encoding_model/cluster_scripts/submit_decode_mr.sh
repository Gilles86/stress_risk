...
python $HOME/git/stress_risk/stress_risk/fmri_analysis/encoding_model/decode.py $PARTICIPANT_LABEL 1 --bids_folder /scratch/mrenke/ds-stressrisk --n_voxels 250 --mask NPC_R  --denoise
