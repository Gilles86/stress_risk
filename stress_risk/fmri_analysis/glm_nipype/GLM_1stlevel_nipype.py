...
import nipype
import argparse
from utils import get_subject_info
...
def main(bids_folder=bids_folder, base_dir="/mnt_01/stressrisk_wf/spm_nipype", Nslices=40, refSlice=20):
    ...
    first_level_wf.connect([
        ...
        (level1conest, datasink, [('spm_mat_file', '1stLevel.@spm_mat'), ('spmT_images', '1stLevel.@T'), ('con_images', '1stLevel.@con')]), 
        ])
    ...
    first_level_wf.config['execution'] = {'stop_on_first_crash':"True",
