...
def main(subject, session, bids_folder, max_rt=1.0):
    ...
    for run in range(1, 7):
        ...
        stim1 = behavior[(behavior['event_type'] == 'stim') & (behavior['phase'] == 4)].copy()
        stim1['n'] = stim1['n1']
        stim1['onset'] -= t0
        stim1['trial_type'] = 'stimulus 1'


        stim2 = behavior[(behavior['event_type'] == 'stim') & (behavior['phase'] == 8)].copy()
        stim2['n'] = stim2['n2']
        stim2['onset'] -= t0
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--bids_folder', default='/Users/mrenke/data/ds-stressrisk')
